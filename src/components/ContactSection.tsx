...
const ContactSection = () => {
  return (
    <section className="py-20 md:py-32 bg-white relative border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="bg-white border border-gray-200 p-8 md:p-14 lg:p-16 rounded-2xl shadow-sm relative overflow-hidden">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            >
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-accent text-accent-foreground text-sm font-semibold px-6 py-3.5 rounded-lg hover:bg-accent/90 transition-all shadow-sm group relative z-10"
                >
                  Chat on WhatsApp
            ...
            >
              <div className="border-l-2 border-gray-200 pl-5 hover:border-accent transition-colors">
                <div className="text-xs font-semibold text-muted-foreground mb-1.5 uppercase tracking-widest">Phone</div>
                <a href="tel:+2348160169189" className="text-foreground hover:text-accent transition-colors text-base font-medium">
                  +234 816 016 9189
                </a>
              </div>
              <div className="border-l-2 border-gray-200 pl-5 hover:border-accent transition-colors">
                <div className="text-xs font-semibold text-muted-foreground mb-1.5 uppercase tracking-widest">Email</div>
                <a href="mailto:housefada@yahoo.com" className="text-foreground hover:text-accent transition-colors text-base font-medium">
                  housefada@yahoo.com
                </a>
              </div>
              <div className="border-l-2 border-gray-200 pl-5 hover:border-accent transition-colors">
              ...
              <div className="border-l-2 border-gray-200 pl-5 hover:border-accent transition-colors">
                ...
                <p className="text-foreground text-base font-medium">2017</p>
              </div>
            </motion.div>
          </div>
        </div>
