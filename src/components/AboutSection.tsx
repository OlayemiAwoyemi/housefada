        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <div className="absolute -bottom-4 -right-4 bg-accent text-accent-foreground px-4 py-2 rounded-xl">
              <div className="text-[10px] font-bold uppercase tracking-widest">Est. 2017</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-6 pt-5 border-t border-foreground-on-light/10 flex items-center gap-6">
              <span className="text-xs text-muted-on-light">RC 9363567</span>
              <span className="text-xs text-muted-on-light">Redemption City, Mowe, Ogun State, Nigeria</span>
              <span className="text-xs text-muted-on-light">Est. 2017</span>
            </div>
          </motion.div>
        </div>
      </div>
